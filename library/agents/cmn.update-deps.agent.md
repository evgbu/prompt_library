...
1. Run the outdated dependencies check script `[prompt_library]/scripts/cmn.check-outdated.js` to identify packages that can be updated within their semver ranges. If no packages are outdated, exit the process.
