...
- The `postinstall` hook runs `scripts/postinstall.js` inside the consuming project. The script configure the repository with settings and files needed to use the prompt library.
